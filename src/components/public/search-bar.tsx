...
export function SearchBar({
  ...
  return (
    <form
      action={action}
      role="search"
      className={cn("relative w-full", size === "lg" && "radar-search")}
    >
      ...
      <Search
        className={
          size === "lg"
            ? "radar-search-icon pointer-events-none absolute top-1/2 left-5 size-[18px] -translate-y-1/2 text-muted"
      ...
      <input
        ...
        className={
          size === "lg"
            ? "radar-search-field field h-[60px] rounded-[9px] pr-[124px] pl-[52px] text-[16px]"
      ...
      <button
        ...
        className={
          size === "lg"
            ? "btn btn-accent absolute top-1/2 right-2 h-[46px] -translate-y-1/2"
