...
/**
 * Country calling codes used by the WhatsApp lead-capture field.
 * India stays first because FundRadar is India-first, while every option keeps
 * its ISO code so countries that share a dial code (for example +1) remain
 * selectable independently in the native dropdown.
 */
